...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "[&>span]:line-clamp-1 placeholder:text-muted-foreground/50",
      "focus:outline-none focus:border-ring/60 focus:ring-2 focus:ring-ring/25 focus:ring-offset-1",
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-3.5 w-3.5 shrink-0 opacity-45 transition-transform duration-150 group-data-[state=open]:rotate-180" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-7 pr-2 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground",
      className,
    )}
    {...props}
  />
