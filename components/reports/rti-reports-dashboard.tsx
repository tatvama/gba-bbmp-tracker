...
export function RtiReportsDashboard({ rtis, firstAppeals, secondAppeals, rules }: DashboardProps) {
  ...
  const renderReportCard = (
    ...
    return (
      ...
      >
        <CardHeader className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 border-b border-slate-100 dark:border-slate-800/60 pb-4">
          ...
          <div className="flex items-center gap-2 self-end sm:self-auto">
            <Button
              variant="outline"
              size="sm"
              onClick={() => exportRows(rows, fileBase, "csv")}
              disabled={rows.length === 0}
              className="h-8 text-xs font-semibold dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-855 rounded-lg"
            >
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => exportRows(rows, fileBase, "xlsx")}
              disabled={rows.length === 0}
              className="h-8 text-xs font-semibold dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-855 rounded-lg"
            >
          ...
          {rows.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-4 text-center">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-sm">
                All RTIs are currently within statutory timelines.
              </p>
            </div>
          ) : (
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-3.5 grid-cols-2 md:grid-cols-4 lg:grid-cols-7">
        ...
        <button
          ...
          className="text-left p-4 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 hover:border-rose-450 dark:hover:border-rose-800 hover:shadow-xs dark:hover:shadow-md transition-all duration-200 flex flex-col justify-between h-29 cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none relative overflow-hidden border-t-2 border-t-rose-500"
        >
          <div className="flex items-center justify-between gap-2 w-full">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-505 dark:text-slate-400">Overdue</span>
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-rose-500/10 text-rose-600 dark:text-rose-400 shrink-0">
          ...
          <span className="text-[9.5px] font-semibold text-rose-600 dark:text-rose-400/90 mt-1">
            Requires Action
          </span>
        </button>
        ...
        <button
          ...
          className="text-left p-4 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 hover:border-amber-450 dark:hover:border-amber-800 hover:shadow-xs dark:hover:shadow-md transition-all duration-200 flex flex-col justify-between h-29 cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none relative overflow-hidden border-t-2 border-t-amber-500"
        >
          <div className="flex items-center justify-between gap-2 w-full">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-505 dark:text-slate-400">Due Soon</span>
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-450 shrink-0">
          ...
          <span className="text-[9.5px] font-semibold text-amber-600 dark:text-amber-455/90 mt-1">
            7 Days Pending
          </span>
        </button>
        ...
        <button
          ...
          className="text-left p-4 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 hover:border-blue-450 dark:hover:border-blue-800 hover:shadow-xs dark:hover:shadow-md transition-all duration-200 flex flex-col justify-between h-29 cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none relative overflow-hidden border-t-2 border-t-blue-500"
        >
          <div className="flex items-center justify-between gap-2 w-full">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-505 dark:text-slate-400">No Reply</span>
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 shrink-0">
          ...
          <span className="text-[9.5px] font-semibold text-blue-600 dark:text-blue-400/90 mt-1">
            Past Deadline
          </span>
        </button>
        ...
        <button
          ...
          className="text-left p-4 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 hover:border-orange-450 dark:hover:border-orange-800 hover:shadow-xs dark:hover:shadow-md transition-all duration-200 flex flex-col justify-between h-29 cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none relative overflow-hidden border-t-2 border-t-orange-500"
        >
          <div className="flex items-center justify-between gap-2 w-full">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-505 dark:text-slate-400">Incomplete</span>
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-orange-500/10 text-orange-600 dark:text-orange-455 shrink-0">
          ...
          <span className="text-[9.5px] font-semibold text-orange-600 dark:text-orange-455/90 mt-1">
            Partial Replies
          </span>
        </button>
        ...
        <button
          ...
          className="text-left p-4 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 hover:border-purple-455 dark:hover:border-purple-800 hover:shadow-xs dark:hover:shadow-md transition-all duration-200 flex flex-col justify-between h-29 cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none relative overflow-hidden border-t-2 border-t-purple-500"
        >
          <div className="flex items-center justify-between gap-2 w-full">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-550 dark:text-slate-400">1st Appeal</span>
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-purple-500/10 text-purple-650 dark:text-purple-400 shrink-0">
          ...
          <span className="text-[9.5px] font-semibold text-purple-600 dark:text-purple-400/90 mt-1">
            Awaiting FAA
          </span>
        </button>
        ...
        >
          <div className="flex items-center justify-between gap-2 w-full">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-550 dark:text-slate-400">2nd Appeal</span>
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-purple-500/10 text-purple-650 dark:text-purple-400 shrink-0">
        ...
        <button
          ...
          className="text-left p-4 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 hover:border-emerald-450 dark:hover:border-emerald-800 hover:shadow-xs dark:hover:shadow-md transition-all duration-200 flex flex-col justify-between h-29 cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none relative overflow-hidden border-t-2 border-t-emerald-500"
        >
          <div className="flex items-center justify-between gap-2 w-full">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-505 dark:text-slate-400">Closed</span>
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-450 shrink-0">
          ...
          <span className="text-[9.5px] font-semibold text-emerald-600 dark:text-emerald-450/90 mt-1">
            This Month
          </span>
        </button>
      </div>
      ...
      <div className="flex items-center gap-3 bg-slate-55 dark:bg-slate-900 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800/80 no-print">
        ...
        <Input
          ...
          className="h-9 border-slate-200 dark:border-slate-800 dark:bg-slate-950/40 text-sm"
        />
        {globalFilter && (
          <Button
            variant="ghost"
            ...
            className="h-9 px-2 text-xs text-slate-500 hover:text-foreground"
          >
            Clear
          </Button>
        )}
